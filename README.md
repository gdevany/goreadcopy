...
1. Smart component VS dumb component
   ...
   * Note: Currently React + Webpack does not not hot reload stateless dumb components. So if you make any changes in these files make sure to do a hard refresh.
