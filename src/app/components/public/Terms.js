    ...
    <div>
      ...
      <p>
        ...
        [This website uses cookies.  By using this website and agreeing to these
          terms and conditions, you consent to GoRead's use of cookies in
          accordance with the terms of GoRead's [privacy policy / cookies policy].]
      </p>
      <h5>
        License to use website
      </h5>
      <p>
        Unless otherwise stated, GoRead and/or its licensors own the intellectual
        ...
        other content from the website for your own personal use, subject to the
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            redistribute material from this website except for
      ...
      <p>
        ...
        and data harvesting on or in relation to this website without express
        written consent from the owners of this website.
        <br />
      ...
      <p>
        Access to certain areas of this website is restricted. GoRead reserves
        the right to restrict access to areas of this website, or indeed this
        entire website, at its own discretion.
        <br />
        If GoRead provides you with a user ID and password to enable you to access
        restricted areas of this website or other content or services, you must
        ensure that the user ID and password are kept confidential.
      </p>
      <p>
        GoRead may disable your user ID and password in it’s sole discretion
      ...
      <p>
        ...
        <br />
        You grant to GoRead a worldwide, irrevocable, non-exclusive, royalty-free
        license to use, reproduce, adapt, publish, translate and distribute your
        user content in any existing or future media.  You also grant to GoRead
        the right to sub-license these rights, and the right to bring an action
        ...
        legal action whether against you or GoRead or a third party (in each
        ...
        similar complaint.
        <br />
        GoRead reserves the right to edit or remove any material submitted to
        this website, or stored on GoRead servers, or hosted or published upon
        this website.
        <br />
        Notwithstanding GoRead rights under these terms and conditions in
        relation to user content, GoRead does not undertake to monitor the
      ...
      <p>
        ...
        express or implied.  GoRead makes no representations or warranties in
      ...
      <p>
        GoRead will not be liable to you (whether under the law of contact,
        ...
        <ul>
          ...
          <li>
            ...
            business relationships, loss of reputation or goodwill,
            or loss or corruption of information or data.
          </li>
        </ul>
        These limitations of liability apply even if GoRead has been expressl
      ...
      <p>
        ...
        and nothing in this website disclaimer will exclude or limit GoRead
        liability in respect of any:
        <ul>
          <li>
            death or personal injury caused by GoRead
            negligence;
          </li>
          <li>
          ...
          <li>
            matter which it would be illegal or unlawful for GoRead to exclude
      ...
      <p>
        You accept that, as a limited liability entity, GoRead has an interest
        in limiting the personal liability of its officers and employees.
        You agree that you will not bring any claim personally against GoRead,
        it’s officers or employees in respect of any losses you suffer in
        ...
        protect GoRead, it’s officers, employees, agents, subsidiaries, successors,
      ...
      <p>
        You hereby indemnify GoRead and undertake to keep GoRead indemnified
        ...
        GoRead to a third party in settlement of a claim or dispute on the
        advice of GoRead legal advisers) incurred or suffered by GoRead
      ...
      <p>
        Without prejudice to GoRead other rights under these terms and conditions,
        if you breach these terms and conditions in any way, GoRead may take
        such action as GoRead deems appropriate to deal with the breach,
      ...
      <p>
        GoRead may revise these terms and conditions from time-to-time.
      ...
      <p>
        GoRead may transfer, sub-contract or otherwise deal with GoRead rights
      ...
      <p>
        ...
        and GoRead in relation to your use of this website, and supersede all
      ...
      <p>
        ...
        accordance with governing law, and any disputes relating to these terms
      ...
      <p>
        The full name of GoRead Inc. is GoRead Inc.
        <br />
        GoRead Inc. is registered in Delaware
        <br />
        You can contact GoRead Inc. by email at
        <a href='mailto:customerservice@goread.com'> customerservice@goread.com </a>
        <br />
        Or by mail at:
        <br />
        <address>
