...
const Antispam = () => {
  return (
    <div>
      ...
      <p>
        Here at <a href='https://goread.com'>GoRead.com</a>, we are strongly against spam,
      ...
      <p>
        ...
        an agreement to receive messaging from either <a href='https://goread.com'>GoRead.com</a>,
        ...
        <a href='https://www.goread.com/profile/settings'> settings</a>.
