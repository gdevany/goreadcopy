...
const FooterColumns = [
  {
    ...
    items: [
      { id: 0, isLink: false, action: '/aboutus', text: 'About' },
      { id: 1, isLink: false, action: '/aboutus', text: 'Careers' },
      { id: 2, isLink: false, action: '/aboutus', text: 'Investor Relations' },
      { id: 3, isLink: false, action: '/aboutus', text: 'Our Mission' },
    ],
  },
  {
    key: 2,
    ...
    items: [
      { id: 0, isLink: false, action: '/aboutus', text: 'GoRead for Authors' },
      { id: 1, isLink: false, action: '/aboutus', text: 'Sell Your Books' },
      { id: 2, isLink: false, action: '/aboutus', text: 'Publish Your Book' },
      { id: 3, isLink: false, action: '/aboutus', text: 'Promote Your Business' },
      { id: 4, isLink: false, action: '/aboutus', text: 'Promote Your Products' },
    ],
  },
  {
    key: 3,
